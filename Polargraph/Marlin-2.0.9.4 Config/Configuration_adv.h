...
#define AXIS_RELATIVE_MODES { false, false, false }  // FLA
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60 } // FLA (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define LASER_FEATURE  // FLA
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    */
    #define LASER_SAFETY_TIMEOUT_MS     0   // FLA 1000 (ms)
